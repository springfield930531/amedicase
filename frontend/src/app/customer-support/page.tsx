...
export async function generateMetadata(): Promise<Metadata> {
  const page = (await getPageBySlugDynamic("customer-support")) as PageEntry | null;
  const seo = page?.seo;
...
export default async function CustomerSupportPage() {
  ...
  if (!page) {
    if (process.env.NODE_ENV !== "production") {
      console.warn("[strapi] Customer support page content not available");
    }
    return (
            ...
            <div className="relative w-full flex flex-col overflow-hidden">
              ...
              <div className="relative h-[562px] w-full -mt-[29px] overflow-hidden">
                <Image
                  ...
                  alt={getAlt((hero && 'backgroundImage' in hero ? hero.backgroundImage : undefined), "Customer support professionals")}
                  fill
                  sizes="100vw"
