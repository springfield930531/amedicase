...
type ServiceStyleCProps = {
  page: PageEntry | null;
};

export function ServiceStyleC({ page }: ServiceStyleCProps) {
            ...
            <div className="relative w-full flex flex-col overflow-hidden">
              ...
              <div className="relative h-[562px] w-full -mt-[29px] overflow-hidden">
                <Image
                  ...
                  alt={getAlt(heroBackgroundImage, "Accounting and finance professionals")}
                  fill
                  sizes="100vw"
            ...
            <div className="relative mx-auto max-w-[1440px] px-4 md:px-8 xl:px-0 h-full flex items-start pt-[15px]">
              ...
              <div className="ml-[60px] mt-[60px] w-[1320px] backdrop-blur-[20px] backdrop-filter bg-gradient-to-b border border-[rgba(158,162,203,0.8)] border-solid from-[rgba(214,222,243,0.32)] rounded-[12px] to-[rgba(143,149,167,0.16)] px-[40px] py-[60px] flex flex-col gap-[69px] min-h-[510px]">
                <div className="flex flex-col gap-[60px] items-start leading-[1.2] text-blue-900 w-full whitespace-pre-wrap">
                  ...
                  >
                    {renderWithBreaks(
                      heroSubtitleDesktop || heroData?.subtitle || fallback.hero.subtitle
                    )}
                  </p>
                </div>
                  ...
                  <div className="relative w-full min-h-[117px]">
                    <div className="absolute inset-0">
                      <Image
                        ...
                        sizes="100vw"
                        className="w-full h-full object-cover"
                        unoptimized={isRemoteUrl(getUrl(gridCards[0]?.backgroundImage, "/images/creative-development/card-bg-1.svg"))}
                      />
                    </div>
                    <div className="relative flex flex-col gap-[10px] p-[20px]">
                      <div className="flex items-start gap-[20px]">
                        <Image
                          ...
                          unoptimized={isRemoteUrl(getUrl(cardGridData?.dotIcon, "/images/creative-development/dot-icon.svg"))}
                        />
                  ...
                  <div className="relative w-full min-h-[117px]">
                    <div className="absolute inset-0">
                      <Image
                        ...
                        sizes="100vw"
                        className="w-full h-full object-cover"
                        unoptimized={isRemoteUrl(getUrl(gridCards[1]?.backgroundImage, "/images/creative-development/card-bg-2.svg"))}
                      />
                    </div>
                    <div className="relative flex flex-col gap-[10px] p-[20px]">
                      <div className="flex items-start gap-[20px]">
                  ...
                  <div className="relative w-full min-h-[145px]">
                    <div className="absolute inset-0">
                      <Image
                        ...
                        sizes="100vw"
                        className="w-full h-full object-cover"
                        unoptimized={isRemoteUrl(getUrl(gridCards[2]?.backgroundImage, "/images/creative-development/card-bg-3.svg"))}
                      />
                    </div>
                    <div className="relative flex flex-col gap-[10px] p-[20px]">
                      <div className="flex items-start gap-[20px]">
                  ...
                  <div className="relative w-full min-h-[145px]">
                    <div className="absolute inset-0">
                      <Image
                        ...
                        sizes="100vw"
                        className="w-full h-full object-cover"
                        unoptimized={isRemoteUrl(getUrl(gridCards[3]?.backgroundImage, "/images/creative-development/card-bg-4.svg"))}
                      />
                    </div>
                    <div className="relative flex flex-col gap-[10px] p-[20px]">
                      <div className="flex items-start gap-[20px]">
              ...
              <div className="flex h-[20px] items-center justify-center w-[44px]">
                <div className="flex-none rotate-90">
                  <Image
                    ...
                    unoptimized={isRemoteUrl(getUrl(processData?.arrowImage, "/images/creative-development/arrow-down.svg"))}
                  />
                </div>
              </div>
              ...
              <div className="flex h-[20px] items-center justify-center w-[44px]">
                <div className="flex-none rotate-90">
                  <Image
                    ...
                    height={44}
                    className="h-[44px] w-[20px]"
                    unoptimized={isRemoteUrl(getUrl(processData?.arrowFinalImage, "/images/creative-development/arrow-down-final.svg"))}
                  />
                </div>
              </div>
