...
import type { MissionValuesSection as MissionValuesSectionData } from "@/lib/page-types";
...
type Props = {
  data?: MissionValuesSectionData;
};

export function MissionValuesSection({ data }: Props) {
        ...
        <div className="relative z-10">
            ...
            <div className="w-full">
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 w-full">
                {cards.map((card, index) => (
                  <div
                    key={`mission-mobile-${index}`}
                    className={`${cardBaseClass} flex flex-col gap-3 p-4 sm:p-5 lg:p-6 text-center`}
                  >
                    <p
                      className="font-sans font-medium text-[#0b1737] text-base sm:text-lg leading-tight tracking-[-0.4px]"
                ...
                <Link
                  href={normalizeHref(cta?.url) || "/services"}
                  data-discover="true"
                ...
                >
                  <p
                    className="font-sans font-semibold leading-[1.2] text-[#f1f5ff] text-[20px] tracking-[-0.4px] text-center"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    {cta?.label || "Explore All Services"}
                  </p>
                  <div className="w-[26px] h-[20px] flex-shrink-0">
                    ...
                    >
                      <path
                        d="M16.6204 1.76403C16.6761 1.37425 16.7408 1.16217 17.0163 0.457581L25.8974 9.82042C26.3675 10.2905 26.3675 11.0525 25.8974 11.5225L18.7187 19.183C18.2486 19.6531 17.4864 19.6531 17.0163 19.183C16.5463 18.7129 16.5463 18.4322 17.0163 17.9621L22.6218 11.8752L1.45371 11.8752C0.788919 11.8752 0.25 11.3363 0.25 10.6715C0.25 10.0067 0.788918 9.46777 1.45371 9.46777L22.6218 9.46777L17.0163 3.8623C16.6204 3.32885 16.5001 2.60662 16.6204 1.76403Z"
                        fill="white"
                      />
                      <path
                        d="M16.6204 19.6559C16.6761 20.0457 16.7408 20.2578 17.0163 20.9623L25.8974 11.5995C26.3675 11.1294 26.3675 10.3675 25.8974 9.89739L18.7187 2.23691C18.2486 1.76684 17.4864 1.76684 17.0163 2.23691C16.5463 2.70699 16.7522 3.46062 17.2223 3.9307L22.7593 9.54474H1.45371C0.788919 9.54474 0.25 10.0837 0.25 10.7484C0.25 11.4132 0.788918 11.9522 1.45371 11.9522L22.7593 11.7548L17.0163 17.5576C16.6204 18.0911 16.5001 18.8133 16.6204 19.6559Z"
                        fill="white"
                      />
                      <path
                        d="M16.6204 1.76403C16.6761 1.37425 16.7408 1.16217 17.0163 0.457581L25.8974 9.82042C26.3675 10.2905 26.3675 11.0525 25.8974 11.5225L18.7187 19.183C18.2486 19.6531 17.4864 19.6531 17.0163 19.183C16.5463 18.7129 16.5463 18.4322 17.0163 17.9621L22.6218 11.8752L1.45371 11.8752C0.788919 11.8752 0.25 11.3363 0.25 10.6715C0.25 10.0067 0.788918 9.46777 1.45371 9.46777L22.6218 9.46777L17.0163 3.8623C16.6204 3.32885 16.5001 2.60662 16.6204 1.76403Z"
          ...
          <div className="hidden md:block lg:hidden">
            <div className="flex flex-col gap-2 items-start mb-8 md:mb-12">
              <p className="font-sans font-medium uppercase text-[15px] w-full whitespace-pre-wrap" style={gradientLabelStyle}>
                {data?.label}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 lg:gap-10 w-full">
              {cards.map((card, index) => (
                ...
                >
                  <h3
                    className="font-sans font-medium text-[clamp(18px,2.5vw,20px)] lg:text-[22px] text-[#0b1737] leading-[1.1] tracking-[-0.02em] mb-4 lg:mb-5 whitespace-pre-line"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    {card.title}
                  </h3>
                  <p
                    className="font-sans font-normal text-[clamp(12px,1.8vw,13px)] lg:text-[15px] text-[#0b1737] leading-[1.2] tracking-[-0.02em] whitespace-pre-line"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    {card.description}
                  </p>
              ...
              >
                <div className="flex items-center gap-3">
                  <p
                    className="font-sans font-semibold text-[clamp(18px,2.5vw,20px)] text-[#f1f5ff] leading-[1.2] tracking-[-0.02em] whitespace-pre-line"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    {cta?.label || "Explore All Services"}
                  </p>
          ...
          <div className="hidden lg:block">
            <div className="flex flex-col gap-2 items-start mb-[60px]">
              <p className="font-sans font-medium uppercase text-[20px]" style={gradientLabelStyle}>
                {data?.label}
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-[43px_55px] w-full justify-start items-stretch">
              {cards.map((card, index) => (
                <div
                  key={`mission-desktop-${index}`}
                  className="backdrop-blur-[10px] backdrop-filter bg-gradient-to-b border border-[rgba(99,103,146,0.8)] from-[rgba(204,211,234,0.25)] to-[rgba(132,139,161,0.125)] rounded-[12px] w-full max-w-[403px] lg:w-[463px] min-h-[142px] flex flex-col shadow-[0px_2px_4px_0px_rgba(114,116,146,0.3)]"
                >
