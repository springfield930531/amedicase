        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-0 max-w-[1440px] w-full">
          ...
          <div className="hidden md:flex lg:hidden items-center justify-between h-20">
            ...
            <nav className="flex items-center gap-6">
              <Link href="/about" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                About
              </Link>
              <Link href="/services" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                Services
              </Link>
              <Link href="/process" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                Process
              </Link>
              <Link href="/case-studies" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                Case Studies
              </Link>
              <Link href="/contact" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                Contact
              </Link>
            </nav>
          ...
          <div className="hidden lg:flex items-center justify-center gap-[61px] h-[60px] px-[60px]">
            ...
            <nav className="backdrop-blur-[6px] backdrop-filter px-[40px] py-[20px] rounded-[12px] shadow-[0px_2px_8px_0px_rgba(255,255,255,0.1)] flex items-center gap-[40px] shrink-0">
              <Link href="/about" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px] leading-none" style={{ fontVariationSettings: "'wdth' 100" }}>
                About
              </Link>
              <Link href="/services" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px] leading-none" style={{ fontVariationSettings: "'wdth' 100" }}>
                Services
              </Link>
              <Link href="/process" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px] leading-none" style={{ fontVariationSettings: "'wdth' 100" }}>
                Process
              </Link>
              <Link href="/case-studies" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px] leading-none" style={{ fontVariationSettings: "'wdth' 100" }}>
                Case Studies
              </Link>
              <Link href="/contact" className="text-[#0b1737] hover:text-[#d01127] transition-colors font-sans font-medium text-[20px] tracking-[-0.4px] leading-none" style={{ fontVariationSettings: "'wdth' 100" }}>
                Contact
              </Link>
            </nav>
